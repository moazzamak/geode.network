...
by the governance executor. The governance executor is a
separate keyless contract with no human key; it holds that one
power, naming and replacing the librarian, and no other.
...
governance executor. The governance executor is a separate
keyless contract with no human key. The role does not rotate on a
...
feeds the keyless replacement discipline.
