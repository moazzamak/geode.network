...
is the detection horizon --- the probed sessions the substitution
...
permissionless settlement work --- posting a root, running a
batch verification, replaying a dispute, tallying a vote --- is
