...
The body states each flow in place. This section collects them
into one map, so a reader can see which pool receives which
payment and where that pool's money leaves the system. Four
