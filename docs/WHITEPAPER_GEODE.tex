...
\begin{description}
    ...
    \item[Librarian.] The role that records credits, the one act
          that still needs a named party. The settlement around it is not
          privilege: anyone may incorporate an entry, post a root,
