...
The claim of this paper is the mechanism, not the market: it
specifies how a network of frozen, replayable capabilities can pay
by measured use and keep its settlement and governance honest, and
it makes no demand forecast.
...
stakeholders who can detect and dispute it — the payer whose
deposit is spent, the contributor whose credit is wrong —
