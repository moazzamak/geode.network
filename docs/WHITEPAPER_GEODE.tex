...
\textbf{What the measurement measures.} The measurement
is fair by construction: the network holds the data, and the
contributor never sees the split. The rules are:
\begin{itemize}
