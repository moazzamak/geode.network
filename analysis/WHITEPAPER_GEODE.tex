...
algorithm. Its parts are old and named. Its value is in the
assembly and the discipline.
\end{abstract}
...
mixture-of-experts routing~\cite{shazeer2017,fedus2022}. The
learned gate is replaced by a public, replayable rule.
...
bridges are optional. On the quickdraw axis --- where four frozen
...
CoMET-class frozen-encoder composition~\cite{comet2026} composes
frozen backbones by concatenation into one predictor; it is not a
registry architecture and carries no attribution. Model
...
\bibitem{bittensor}
A.~Shaabana, J.~Alaeddin, and Y.~Saeed.
Bittensor: a peer-to-peer intelligence market.
Whitepaper, 2021.

\bibitem{ruckle2020}
J.~R\"uckl\'e, G.~Grese, R.~R.~Cahyawijaya, G.~Wijaya,
B.~Steiner, R.~Sharma, I.~Vuli\'c, and S.~Ruder.
AdapterHub: a framework for adapting transformers.
\emph{EMNLP (Demonstrations)}, 2020.

\bibitem{comet2026}
CoMET: composing modality encoders with tabular foundation models
for multimodal classification without fine-tuning.
\emph{arXiv}, 2026.
