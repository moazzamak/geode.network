...
and the reward follows the work. It is an operator key, named at
bootstrap by the developer's key and at maturity by the
...
the network does not yet carry. It is an operator key, named at
bootstrap by the developer's key and at maturity by the
governance executor, a keyless contract with
